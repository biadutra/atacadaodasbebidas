...
// =======================
// Produtos (exemplo: adicione flags temUnidade e temFardo)
// =======================
const produtos = [
...
function renderizarProdutos() {
  ...
  produtos.forEach(prod => {
    if (prod.secao) {
      // Esta linha já foi ajustada e está correta para usar o nome da seção como ID
      ...
      `;
      // Só mostra unidade se permitido
      if (prod.temUnidade) {
        html += `
...
// ... (o restante do seu código script.js)
// =======================
// Atualizar Carrinho
// =======================
...
if (elementos.btnMenuMobile) {
  elementos.btnMenuMobile.addEventListener('click', (e) => {
    e.stopPropagation();
    elementos.carrinhoDiv.classList.toggle('aberto');
    document.body.classList.toggle('carrinho-aberto');
    const expanded = elementos.btnMenuMobile.getAttribute('aria-expanded') === 'true';
    elementos.btnMenuMobile.setAttribute('aria-expanded', !expanded);
  });
}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (botaoMenuLateral && menuLateral && fecharMenu) {
